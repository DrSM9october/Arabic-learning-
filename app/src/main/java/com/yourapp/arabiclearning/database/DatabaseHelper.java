...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void insertAllPhrases(SQLiteDatabase db) {
        ...
        // ==========================================
// بخش دوم: لهجه لبنانی (۱۳۰ جمله) - نسخه کامل
// ==========================================
String[][] lebanese = {
    // ----- احوالپرسی (۲۰ جمله) -----
    ...
    {"شُو مَعَكَ؟", "چی داری؟ (مذکر)", "shu ma'ak", "lebanese", "male", "greeting", "intermediate"},
    {"شُو مَعَكِ؟", "چی داری؟ (مونث)", "shu ma'ik", "lebanese", "female", "greeting", "intermediate"},
    ...
    {"شُو عَمَلَكَ؟", "شغلت چیه؟ (مذکر)", "shu 'amalak", "lebanese", "male", "introduction", "intermediate"},
    ...
    {"كَم عُمرَكَ؟", "چند سالته؟ (مذکر)", "kam 'omrak", "lebanese", "male", "daily", "intermediate"},
    {"كَم عُمرَكِ؟", "چند سالته؟ (مونث)", "kam 'omrik", "lebanese", "female", "daily", "intermediate"},
    ...
    {"يَلّا نْروح", "بریم", "yalla nrou7", "lebanese", "neutral", "expression", "intermediate"},
